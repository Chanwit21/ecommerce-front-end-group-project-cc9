...
import { validateCategory, validateColorCode, validateColorName, validateDescription, validateImageFile, validateImageShow, validateIngredients, validatePrice, validateProductName, validateQuantity } from '../service/validateForm';
...
function CreateProduct() {
    ...
    if (location?.state?.edit) {
      ...
      const run = async () => {
        try {
          ...
          const { data: { productImage } } = await axios.get(`/product/productImage/${product.id}`)
  ...
  const handleClickUpdate = async () => {
    try {
      ...
      if (errorProductName || errorPrice || errorQuantity || errorCategory || errorColorName || errorColorCode || errorDescription || errorIngredients || errorImageShow) {
        return;
      }
  ...
  const handleClickSave = async () => {
    ...
    if (errorProductName || errorPrice || errorQuantity || errorCategory || errorColorName || errorColorCode || errorDescription || errorIngredients || errorImageFile) {
      return;
    }
  ...
  const inputOnChange = e => {
    if (e.target.id === 'productName') setError(cur => ({ ...cur, [e.target.id]: validateProductName(e.target.value) }))
    ...
    if (e.target.id === 'description') setError(cur => ({ ...cur, [e.target.id]: validateDescription(e.target.value) }))
    if (e.target.id === 'productNingredientsame') setError(cur => ({ ...cur, [e.target.id]: validateIngredients(e.target.value) }))
        ...
        <div style={{ width: '70%' }}>
          <div className='row mt-5 mb-5'>
            <div className='col-12 mb-5'>
              <h3 style={{ textAlign: 'center' }}>{`${location?.state?.edit ? 'EDIT PRODUCT' : 'CREATE NEW PRODUCT'}`}</h3>
            </div>
            <div className='col-12 mb-2'>
              <label htmlFor='productName' className='form-label'>
                Product Name
              </label>
              <input value={productData.productName} onChange={e => inputOnChange(e)} type='text' id='productName' className={`form-control ${error.productName ? ' is-invalid' : ''}`} />
            ...
            <div className='col-6 mb-2'>
              ...
              <input value={productData.price} onChange={e => inputOnChange(e)} type='text' id='price' className={`form-control ${error.price ? ' is-invalid' : ''}`} />
            ...
            <div className='col-6 mb-2'>
              ...
              <input value={productData.quantity} onChange={e => inputOnChange(e)} type='text' id='quantity' className={`form-control ${error.quantity ? ' is-invalid' : ''}`} />
            ...
            <div className='col-6 mb-2'>
              ...
              <input value={productData.colorName} onChange={e => inputOnChange(e)} type='text' id='colorName' className={`form-control ${error.colorName ? ' is-invalid' : ''}`} />
            ...
            <div className='col-6 mb-2'>
              ...
              <input value={productData.colorCode} onChange={e => inputOnChange(e)} type='text' id='colorCode' className={`form-control ${error.colorCode ? ' is-invalid' : ''}`} />
            ...
            <div className='col-12 mb-2'>
              ...
              <textarea value={productData.description} onChange={e => inputOnChange(e)} className={`form-control ${error.description ? ' is-invalid' : ''}`} id='description' style={{ height: '11.45833333333333vw' }}></textarea>
            ...
            <div className='col-12 mb-2'>
              ...
              <textarea value={productData.ingredients} onChange={e => inputOnChange(e)} className={`form-control ${error.ingredients ? ' is-invalid' : ''}`} id='ingredients' style={{ height: '11.45833333333333vw' }}></textarea>
            ...
            <div className='d-flex mt-3'>
              ...
              <div className='col-4 d-flex justify-content-center align-items-center'>
                {location?.state?.edit ?
                  <button onClick={handleClickUpdate} className='btn btn-dark' style={{ minWidth: '9.375vw', minHeight: '2.604166666666667vw' }}>
                    UPDATE
                  </button> :
                  <button onClick={handleClickSave} className='btn btn-dark' style={{ minWidth: '9.375vw', minHeight: '2.604166666666667vw' }}>
                    SAVE
                  </button>
                }
              </div>
