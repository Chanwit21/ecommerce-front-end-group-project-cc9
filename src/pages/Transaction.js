...
function Transaction() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      const {
        ...
        `/transaction?startTime=${startTime}&endTime=${endTime}&selectedTime=${selectedTime}`
      );
      ...
      selectedTime === "day" ||
        setShowTime([
          startTime.split("T")[0].split("-").join("/"),
          endTime.split("T")[0].split("-").join("/"),
        ]);
      selectedTime === "day" &&
        setShowTime([startTime.toDateString(), endTime.toDateString()]);

      //* set income
      setShowSumIncome(
        order.reduce((acc, item) => acc + +item.amount, 0).toFixed(2)
      );
    };
    run();
  ...
  const categoryImg = {
    foundation:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998904/Foundation_phqyge.jpg",
    power:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Lip_Balm_jck6hf.png",
    concealer:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998904/Concealer_aocfpl.png",
    primer:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Primer_fkjcm3.jpg",
    blush:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998899/Blush_kv89pz.jpg",
    bronzer:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998904/Bronzer_ngvzby.jpg",
    highlighter:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Highlighter_mc29py.jpg",
    liquidLipstick:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Liquid_Lip_ipjiux.png",
    lipstick:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Libstick_dt5dbz.png",
    lipLiner:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Lip_Liner_vuizz8.png",
    lipBlam:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Lip_Balm_jck6hf.png",
    eyeShadow:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Eyeshadow_bdtaa7.png",
    eyeBrows:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Eyebrows_jfxtxf.png",
    eyeLiner:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998904/Eyeliner_np6msk.png",
    mascara:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998905/Mascara_oyfzhv.png",
    bodyMakeup:
      "https://res.cloudinary.com/dtwk9plkp/image/upload/v1634998903/Body_cd2xfp.png",
  };
