    ...
    <div className='productDescriptionPage'>
      ...
      <div>
        <div className='card m-4 p-4'>
          ...
          <h5>PRODUCT INFO</h5>
          <span>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio quo eius nostrum dicta assumenda dignissimos!
            Nulla eius dicta dolorem voluptate consequatur hic harum eaque sapiente, enim repudiandae magnam sed beatae
            aliquam cum ab aliquid sequi asperiores consequuntur aperiam. Hic, laborum! Nulla quo molestiae, esse
            eligendi et id quibusdam odit omnis!
          </span>
        </div>
        <div className='card m-4 p-4'>
          {/* ingreduents*/}
